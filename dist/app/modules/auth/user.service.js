...
const ProxysetService = async (req) => {
    try {
        ...
        if (!userId || !ProxysetUserId || !mongoose_1.default.Types.ObjectId.isValid(userId) || !mongoose_1.default.Types.ObjectId.isValid(ProxysetUserId)) {
        ...
        const ProxysetUserIdObjectId = new mongoose_1.default.Types.ObjectId(ProxysetUserId);
        const user = await user_model_1.User.findById(userId);
        if (!user) {
